        ...
        if config.START_IMG_URL:
            try:
                ...
                await message.reply_text(
                    _["start_2"].format(user=message.from_user.mention),
                    reply_markup=InlineKeyboardMarkup(out),
                    parse_mode="html",
                    disable_web_page_preview=True,
                )
            ...
            await message.reply_text(
                _["start_2"].format(config.MUSIC_BOT_NAME,user=message.from_user.mention),
                reply_markup=InlineKeyboardMarkup(out),
                parse_mode="html",
                disable_web_page_preview=True,
            )
...
async def testbot(client, message: Message, _):
    ...
    return await message.reply_text(
        _["start_1"].format(
            message.chat.title,user=message.from_user.mention
        ),
        reply_markup=InlineKeyboardMarkup(out),
        parse_mode="html",
        disable_web_page_preview=True,
